            ...
            <nav class="nav">
                <div>
                    ...
                    <div class="nav_list">
                        ...
                        <a href="like.php" class="nav_link active">
        ...
        <div class="height-100 bg-light">
            <table class="comment-table">
                <thead>
                    <t5>
                        <th colspan="5">
                            <h1 style="color: white;">Users Like</h1>
                        </th>
                        </tr>
                        <tr>
                            <th>Blog Title</th>
                ...
                <tbody>
                    <?php
                    // Assuming you want to display comments ordered by `b_id`
                    $comment = $conn->query("SELECT * FROM `like` ORDER BY u_id");

                    while ($res = $comment->fetch_assoc()) { ?>
                        <tr>
                            <td><?php echo htmlspecialchars($res['title']); ?></td>
                            <td><?php echo htmlspecialchars($res['user']); ?></td>
                            <td><?php echo htmlspecialchars($res['like_date']); ?></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>

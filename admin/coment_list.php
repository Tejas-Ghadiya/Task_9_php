            ...
            <nav class="nav">
                <div>
                    ...
                    <div class="nav_list">
                        ...
                        <a href="coment_list.php" class="nav_link active">
        ...
        <div class="height-100 bg-light">
            <table class="comment-table">
                <thead>
                    <t5>
                        <th colspan="5">
                            <h1 style="color: white;">Users Comment </h1>
                        </th>
                        </tr>
                        <tr>
                            <th>Title</th>
                ...
                <tbody>
                    ...
                    $comment = $conn->query("SELECT * FROM `comment` ORDER BY b_id");
                    ...
                    while ($res = $comment->fetch_assoc()) { ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($res['comment_time']); ?></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
